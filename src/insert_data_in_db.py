...
from src.models import Base, Ingredient, IngredientsInRecipe, Recipe
...
async def async_main():
    ...
    # Вставка рецептов
    await add_data(several_recipes)
    # Вставка ингредиентов
    await add_data(several_ingredients)
    # Связь рецептов с ингредиентами
    await add_data(relationship_ingredients_to_recipes)
